    ...
    return (
      <div class="about_container">
        ...
        <div class="about_block">
          ...
          <p>Application helps you to manage your time, creating list of todos. Also it saves list of
          thing you've already done, and your notifications.</p>
        </div>

        <div class="about_block">
          <h2>Motivation:</h2>

          <p>Such kind of apps help me to organize my free time, and also it was a good practice of
          writting apps using React library and Redux architecture.</p>
        </div>
